state("CrabChampions-Win64-Shipping") {
	...
	int   gamestate : 0x042A7180, 0x120, 0x278;
	
	int   level     : 0x042A7180, 0x120, 0x2BC;
	float health    : 0x0428F7A0, 0x30, 0x228, 0x38C; // read-out of the current health, not the actual health
}
