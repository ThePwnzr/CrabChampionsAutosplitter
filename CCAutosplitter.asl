state("CrabChampions-Win64-Shipping") {
	...
	uint  gamestate : 0x043C7BC8, 0x120, 0x278;
	
	uint  level     : 0x043C7BC8, 0x120, 0x2BC;
	float health    : 0x043B0180, 0x30, 0x228, 0x38C; // read-out of the current health, not the actual health
}
